...
$(document).on('ready', function() {
    "use strict";
    var $active = $('#accordion-5 .panel-collapse.in').prev().addClass('active');
    $active.find('a').prepend('<i class="fa fa-minus-circle sign"></i>');
    $('#accordion-5 .panel-heading').not($active).find('a').prepend('<i class="fa fa-plus-circle sign"></i>');
    $('#accordion-5').on('show.bs.collapse', function(e) {
        $('#accordion-5 .panel-heading.active').removeClass('active').find('.fa').toggleClass('fa-plus-circle fa-minus-circle');
        $(e.target).prev().addClass('active').find('.fa').toggleClass('fa-plus-circle fa-minus-circle');
    })
});
...
$(document).on('ready', function() {
    "use strict";
    var $active = $('#accordion-8 .panel-collapse.in').prev().addClass('active');
    $active.find('a').prepend('<i class="fa fa-minus-circle sign"></i>');
    $('#accordion-8 .panel-heading').not($active).find('a').prepend('<i class="fa fa-plus-circle sign"></i>');
    $('#accordion-8').on('show.bs.collapse', function(e) {
        $('#accordion-8 .panel-heading.active').removeClass('active').find('.fa').toggleClass('fa-plus-circle fa-minus-circle');
        $(e.target).prev().addClass('active').find('.fa').toggleClass('fa-plus-circle fa-minus-circle');
    })
});
...
$(document).on('ready', function() {
    "use strict";
    var $active = $('#accordion-9 .panel-collapse.in').prev().addClass('active');
    $active.find('a').prepend('<i class="fa fa-minus-circle sign"></i>');
    $('#accordion-9 .panel-heading').not($active).find('a').prepend('<i class="fa fa-plus-circle sign"></i>');
    $('#accordion-9').on('show.bs.collapse', function(e) {
        $('#accordion-9 .panel-heading.active').removeClass('active').find('.fa').toggleClass('fa-plus-circle fa-minus-circle');
        $(e.target).prev().addClass('active').find('.fa').toggleClass('fa-plus-circle fa-minus-circle');
    })
});