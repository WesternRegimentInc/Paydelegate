            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php site_url('/admin/gift'); ?>">
                                Gift Card </a>
                        </li>
                        <li class="pull-right">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($gR as $n):
                                            ...
                                            if ($edit === $n->tid1) {
                                                ...
                                                echo '<tr>' . form_open("admin/request/updategift/$n->tid1") . '
                                                <td>' . $i . '</td>
                                                <td>' . $n->fullName . '</td>
                                                <td>' . $n->email . '</td>
                                                <td>' . $n->date . '</td>
                                                ...
                                                <td><input class="form-control" type="text" value="' . $n->amount_usd . '" name="amount" required /></td>
                                                <td><input class="form-control" type="text" value="' . $n->amount_naira . '" name="amountExchange" required /></td>
                                                <td>
                                                <select name="status">';
                                                if ($st) :
                                                    $stt = $n->status;
                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>' . $n->des . '</td>
                                                    <td>' . $n->amount_usd . '</td>
                                                    <td>' . $n->amount_naira . '</td>
                                                    <td>' . $n->name . '</td>
                                                    <td>
                                                    <a href="' . site_url() . '/admin/request/gift/edit/' . $n->tid1 . '" class="btn"><i class="fa fa-pencil"></i>Edit</a>
                                                    <a href="' . site_url() . '/admin/request/deletegift/' . $n->tid1 . '" id="del_status" class="btn"><i class="fa fa-times"></i>Delete</a>
                                                    </td>
                                                    </tr>';
                                        }
