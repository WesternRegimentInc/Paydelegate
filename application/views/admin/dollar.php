            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php site_url('admin/request'); ?>">
                                Request </a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="<?php site_url('admin/dollar'); ?>">
                                Dollar </a>
                        </li>
                        <li class="pull-right">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dR as $n):
                                            ...
                                            if ($edit === $n->req_id) {
                                                ...
                                                echo '<tr>' . form_open("admin/request/updatedollar/$n->req_id") . '
                                                <td>' . $i . '</td>
                                                <td>' . $n->fullName . '</td>
                                                <td>' . $n->email . '</td>
                                                <td>' . $n->date . '</td>
                                                ...
                                                <select class="form-control" id="country" name="country">';
                                                ?>
                                                    <option value="United States" <?php if($n->country == "United States"){ echo 'selected'; } ?>>United States</option>
                                                    <option value="United Kindgom" <?php if($n->country == "United Kindgom"){ echo 'selected'; } ?>>United Kingdom</option>
                                                    <option value="China" <?php if($n->country == "China"){ echo 'selected'; } ?>>China</option>
                                                    <option value="Canada" <?php if($n->country == "Canada"){ echo 'selected'; } ?>>Canada</option>
                                                    <option value="EU Country" <?php if($n->country == "EU Country"){ echo 'selected'; } ?>>EU Country</option>
                                                <?php
                                                echo '</select>
                                                </td>
                                                ...
                                                echo '<tr>
                                                    ...
                                                    <td>' . $n->name . '</td>
                                                    <td>
                                                    <a href="' . site_url() . '/admin/request/dollar/edit/' . $n->req_id . '" class="btn"><i class="fa fa-pencil"></i>Edit</a>
                                                    <a href="' . site_url() . '/admin/request/deletedollar/' . $n->req_id . '" id="del_status" class="btn"><i class="fa fa-times"></i>Delete</a>
                                                    </td>
                                                    </tr>';
                                            }
