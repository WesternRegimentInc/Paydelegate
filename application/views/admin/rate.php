                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Rate</strong></h3><br />
                                <?php if ($msg): ?>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($rate as $s):
                                            ...
                                            if ($edit === $s->id) {
                                                ...
                                                echo '<tr>' . form_open("admin/rate/update/$s->id") . '
                                                <td>' . $i . '</td>
                                                <input name="redirect" type="hidden" value="'. $this->uri->uri_string() .'" />
                                                <td><input class="form-control" type="text" value="' . $s->buy_rate . '" name="buy_rate" required /></td>
                                                <td><input class="form-control" type="text" value="' . $s->sell_rate . '" name="sell_rate" required /></td>
                                                <td><input class="form-control" type="text" value="' . $s->currency . '" name="currency" required /></td>
                                                ...
                                                echo '<tr>
                                                    ...
                                                    <a href="' . site_url() . '/admin/rate/index/edit/' . $s->id . '" class="btn"><i class="fa fa-pencil"></i>Edit</a>
                                                    <a href="' . site_url() . '/admin/rate/delete/' . $s->id . '" id="del_rate" onclick="window.oh();" class="btn"><i class="fa fa-times"></i>Delete</a>
                                                    </td>
                                                    </tr>';
                                            }
