            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        <li><i class="fa fa-home"></i> <a href="<?php echo site_url('admin/dashboard'); ?>"> Dashboard </a>
                            <i class="fa fa-angle-right"></i></li>
                        <li><a href="<?php echo site_url('admin/staff'); ?>"> Staff </a> <i class="fa fa-angle-right"></i></li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Staff</strong></h3><br />
                                <?php if ($msg): ?>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <?php echo form_open('admin/staff/create', 'class="form-horizontal"'); ?>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($user as $s):
                                            ...
                                            if ($edit === $s->id) {
                                                ...
                                                echo '<tr>' . form_open("admin/staff/update/$s->id") . '
                                                <td>' . $i . '</td>
                                                ...
                                                if ($role) :
                                                    ...
                                                    <?php if ($role->id == $stt){echo 'selected';} ?>>
                                                ...
                                                echo '<tr>
                                                    ...
                                                    <a href="' . site_url() . '/admin/staff/index/edit/' . $s->id . '" class="btn"><i class="fa fa-pencil"></i>Edit</a>
                                                    <a href="' . site_url() . '/admin/staff/delete/' . $s->id . '" id="del_status" onclick="window.oh();" class="btn"><i class="fa fa-times"></i>Delete</a>
                                                    </td>
                                                    </tr>';
                                            }
